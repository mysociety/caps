...
class TestMapitResponses(TestCase):
    ...
    def test_gss_code_to_mapit_id(self, mapit_session):
        mapit_session.get.return_value.json.return_value = {'id': 2650,
                                                            'type': 'UTA',
    ...
    def test_mapit_id_to_touches(self, mapit_session):
        mapit_session.get.return_value.json.return_value = {'151155': {'name': 'East Garioch',
                                                                       'id': 151155,
                                                                       'country': 'S',
                                                                       'type': 'UTW',
                                                                       'codes': {'unit_id': '27271',
