...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("baseurl", nargs='?', default="http://councilclimatescorecards.0.0.0.0.nip.io:8000", help="base url of site, eg: 'http://example.org'")
    ...
    def handle(self, *args, **options):
        ...
        tqdm.write(f"Generating open graph images for {councils.count()} councils into {og_images_dir}")
        ...
        tqdm.write(f"Generating open graph images for {sections.count()} sections into {og_images_dir}")
